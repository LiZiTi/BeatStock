  ...
  <div class="fund-flow">
    <div class="table-section">
      ...
      <vxe-table :data="orderedSectors" border round height="100%" size="large" align="center"
        ...
        show-header>
        <vxe-column field="名称" title="行业版块" width="120"></vxe-column>
        ...
        <vxe-column field="今日主力净流入最大股" title="今日主力流入最大股" width="180"></vxe-column>
        <vxe-column field="5日主力净流入最大股" title="5日主力流入最大股" width="180"></vxe-column>
        <vxe-column field="10日主力净流入最大股" title="10日主力流入最大股" width="180"></vxe-column>
      </vxe-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    async fetchFundFlowData() {
      try {
        const response = await api.get("/sector-fund-flow-all", { params: { sector_type: "行业资金流" } });
